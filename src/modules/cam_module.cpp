    ...
    : QObject(parent)
{
    ...
    CamConfig& config = CamConfig::instance();
    ...
    connect(LcncApplication::instance(), &LcncApplication::documentModified,
...
void CamModule::setMachineModelPath(const QString& filePath)
{
    ...
    CamConfig::instance().setMachineModelPath(m_machineModelPath);
}
...
void CamModule::setMachineRenderQuality(MachineRenderQuality quality)
{
    ...
    CamConfig::instance().setMachineRenderQuality(quality);
...
void CamModule::configureMachine(const QString& presetName)
{
    ...
    CamConfig::instance().setMachinePreset(presetName);
...
void CamModule::setAxisOrigin(const QString& axisName, const gp_Pnt& origin)
{
    ...
    if (!m_machineModelPath.isEmpty())
        CamConfig::instance().setAxisOriginForMachine(m_machineModelPath, axisName, origin);
...
void CamModule::setCutterHeadModelPosition(const gp_Pnt& position)
{
    ...
    if (!m_machineModelPath.isEmpty()) {
        CamConfig::instance().setCutterHeadModelPositionForMachine(
            m_machineModelPath,
...
void CamModule::setCutterHeadPhysicalPosition(const gp_Pnt& position)
{
    ...
    if (!m_machineModelPath.isEmpty()) {
        CamConfig::instance().setCutterHeadPhysicalPositionForMachine(
            m_machineModelPath,
...
void CamModule::setWorkpieceInstallPosition(const gp_Pnt& position)
{
    ...
    if (!m_machineModelPath.isEmpty()) {
        CamConfig::instance().setWorkpieceInstallPositionForMachine(
            m_machineModelPath,
