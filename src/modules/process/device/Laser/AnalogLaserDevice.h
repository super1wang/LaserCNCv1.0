...
public:
	...
	virtual bool			IsAvailableData(const QByteArray& data) { return true; };
	...
	// 下发参数
	virtual bool			SetEnergy(double dEnergy) { return true; };
	virtual bool			SetFrequency(double dFrequency) { return true; };
	virtual bool			SetPulseWidth(double dPulseWidth) { return true; };
