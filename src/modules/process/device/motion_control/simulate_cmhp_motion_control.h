...
public:
    ...
    bool Home(lcnc::process::Axis axis) override; bool Home() override; bool StopHome() override; bool IsHomed() override; bool IsHomed(lcnc::process::Axis axis) override;
    bool Enable(lcnc::process::Axis axis) override; bool Enable() override; bool Disable(lcnc::process::Axis axis) override; bool Disable() override; bool IsEnabled(lcnc::process::Axis axis) override; bool IsEnabled() override; bool SetAxisEnable(lcnc::process::Axis axis, bool enabled) override;
    ...
    bool MoveMRelative(std::vector<lcnc::process::Axis> axes, std::vector<double> positions, double velocity) override;
    bool MoveAbsolute(lcnc::process::Axis axis, double position, double velocity) override;
    bool MoveMAbsolute(std::vector<lcnc::process::Axis> axes, std::vector<double> positions, double velocity) override;
    bool StopMotion(lcnc::process::Axis axis) override; bool StopMotion() override; bool HaltMotor(lcnc::process::Axis axis) override;
    bool IsAxisMoving(lcnc::process::Axis axis) override; bool IsAxisMoving() override;
    bool GetActualPos(lcnc::process::Axis axis, double& position) override; bool GetFeedbackPos(lcnc::process::Axis axis, double& position) override;
    ...
    bool SetAxisIndex(lcnc::process::Axis axis, int value) override; bool SetAxisHomeBufferIndex(lcnc::process::Axis axis, int value) override; bool SetAxisIsRotary(lcnc::process::Axis axis, bool value) override; bool SetAxisResolution(lcnc::process::Axis axis, int value) override; bool SetAxisTubeDiamater(lcnc::process::Axis axis, double value) override; bool SetAxisVel(lcnc::process::Axis axis, double value) override; bool SetAxisAcc(lcnc::process::Axis axis, double value) override; bool SetAxisDec(lcnc::process::Axis axis, double value) override; bool SetAxisJerk(lcnc::process::Axis axis, double value) override; bool SetAxisNegLimit(lcnc::process::Axis axis, double value) override; bool SetAxisPosLimit(lcnc::process::Axis axis, double value) override; bool SetAxisVelAccDecJerk(lcnc::process::Axis axis, double vel, double acc, double dec, double jerk) override; bool SetAxisSoftLimit(lcnc::process::Axis axis, double neg, double pos) override;
    bool GetAxisIndex(lcnc::process::Axis axis, int& value) override; bool GetAxisHomeBufferIndex(lcnc::process::Axis axis, int& value) override; bool GetAxisIsRotary(lcnc::process::Axis axis, bool& value) override; bool GetAxisResolution(lcnc::process::Axis axis, int& value) override; bool GetAxisTubeDiamater(lcnc::process::Axis axis, double& value) override; bool GetAxisVel(lcnc::process::Axis axis, double& value) override; bool GetAxisAcc(lcnc::process::Axis axis, double& value) override; bool GetAxisDec(lcnc::process::Axis axis, double& value) override; bool GetAxisJerk(lcnc::process::Axis axis, double& value) override; bool GetAxisNegLimit(lcnc::process::Axis axis, double& value) override; bool GetAxisPosLimit(lcnc::process::Axis axis, double& value) override; bool GetAxisVelAccDecJerk(lcnc::process::Axis axis, double& vel, double& acc, double& dec, double& jerk) override; bool GetAxisSoftLimit(lcnc::process::Axis axis, double& neg, double& pos) override; void ReadAxisSoftLimit(lcnc::process::Axis axis, double& neg, double& pos) override;
