...
QString processNodeTypeToString(ProcessNodeType type)
{
    ...
    case ProcessNodeType::IO: return QStringLiteral("OutputSignal");
    case ProcessNodeType::Camera: return QStringLiteral("Camera");
    case ProcessNodeType::Monitor: return QStringLiteral("InputSignalWait");
    ...
    case ProcessNodeType::Axis: return QStringLiteral("SingleAxisMove");
    case ProcessNodeType::AxesMove: return QStringLiteral("MultiAxisMove");
    ...
    case ProcessNodeType::Cutting: return QStringLiteral("NormalCutting");
...
ProcessNodeType processNodeTypeFromString(const QString& text)
{
    ...
    if (normalized == QStringLiteral("IO") || normalized == QStringLiteral("OutputSignal")) return ProcessNodeType::OutputSignal;
    if (normalized == QStringLiteral("Camera")) return ProcessNodeType::Camera;
    if (normalized == QStringLiteral("Monitor") || normalized == QStringLiteral("InputSignalWait")) return ProcessNodeType::InputSignalWait;
    ...
    if (normalized == QStringLiteral("Axis") || normalized == QStringLiteral("SingleAxisMove")) return ProcessNodeType::SingleAxisMove;
    if (normalized == QStringLiteral("AxesMove") || normalized == QStringLiteral("MultiAxisMove")) return ProcessNodeType::MultiAxisMove;
    ...
    if (normalized == QStringLiteral("Cutting") || normalized == QStringLiteral("NormalCutting")) return ProcessNodeType::NormalCutting;
