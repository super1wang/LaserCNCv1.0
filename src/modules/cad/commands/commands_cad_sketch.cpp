...
{
    // 中文翻译：新建草图
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("Create a new sketch"), this);
    // 中文翻译：在默认 XY 平面新建草图
...
{
    // 中文翻译：退出草图
    auto* a = new QAction(QIcon("themeicons:exit_sketch.svg"), tr("Exit sketch"), this);
    // 中文翻译：完成当前草图并生成建模轮廓
...
{
    // 中文翻译：取消草图
    auto* a = new QAction(QIcon("themeicons:close.svg"), tr("Cancel sketch"), this);
...
{
    // 中文翻译：点
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("point"), this);
    // 中文翻译：草图工具：插入点
...
{
    // 中文翻译：直线
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("straight line"), this);
    // 中文翻译：草图工具：绘制直线段
...
{
    // 中文翻译：圆弧
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("Arc"), this);
    // 中文翻译：草图工具：三点圆弧
...
{
    // 中文翻译：圆
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("round"), this);
    // 中文翻译：草图工具：圆
...
{
    // 中文翻译：矩形
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("Rectangle"), this);
    // 中文翻译：草图工具：矩形
...
{
    // 中文翻译：多边形
    auto* a = new QAction(QIcon("themeicons:sketch.svg"), tr("polygon"), this);
    // 中文翻译：草图工具：等边多边形
