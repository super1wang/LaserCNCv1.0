...
{
    // 中文翻译：长方体
    auto* a = new QAction(QIcon("themeicons:box.svg"), tr("cuboid"), this);
    // 中文翻译：创建长方体基本体
...
{
    // 中文翻译：圆柱体
    auto* a = new QAction(QIcon("themeicons:cylinder.svg"), tr("cylinder"), this);
    // 中文翻译：创建圆柱体基本体
...
{
    // 中文翻译：球体
    auto* a = new QAction(QIcon("themeicons:sphere.svg"), tr("sphere"), this);
    // 中文翻译：创建球体基本体
...
{
    // 中文翻译：圆锥体
    auto* a = new QAction(QIcon("themeicons:cone.svg"), tr("cone"), this);
    // 中文翻译：创建圆锥体（或截锥体）
...
{
    // 中文翻译：圆环体
    auto* a = new QAction(QIcon("themeicons:torus.svg"), tr("torus"), this);
    // 中文翻译：创建圆环体基本体
